...
public class Utilidades {
    ...
    public final static String STRING_ZONA_HORARIA = "GMT-5";
    public final static String STRING_TIME_STAMP ="timestamp";
    ...
    public static Timestamp getTimeStamp(ResultSet rs, String columna) {
        try {
            Calendar horarioColombia = Calendar.getInstance(TimeZone.getTimeZone(STRING_ZONA_HORARIA));
            return rs.getTimestamp(columna, horarioColombia);
        }catch (Exception ex){
            return null;
        }
    }
