...
public class Zona  implements Serializable  {
  ...
  private String entreSemanaInicia = null;

  @JsonProperty("entreSemanaTermina")
  private String entreSemanaTermina = null;

  @JsonProperty("finSemanaInicia")
  private String finSemanaInicia = null;

  @JsonProperty("finSemanaTermina")
  private String finSemanaTermina = null;
  ...
  public Zona entreSemanaInicia(String entreSemanaInicia) {
  ...
  @Schema(description = "")
    ...
    public String getEntreSemanaInicia() {
    return entreSemanaInicia;
  }

  public void setEntreSemanaInicia(String entreSemanaInicia) {
    this.entreSemanaInicia = entreSemanaInicia;
  }

  public Zona entreSemanaTermina(String entreSemanaTermina) {
  ...
  @Schema(description = "")
    ...
    public String getEntreSemanaTermina() {
    return entreSemanaTermina;
  }

  public void setEntreSemanaTermina(String entreSemanaTermina) {
    this.entreSemanaTermina = entreSemanaTermina;
  }

  public Zona finSemanaInicia(String finSemanaInicia) {
  ...
  @Schema(description = "")
    ...
    public String getFinSemanaInicia() {
    return finSemanaInicia;
  }

  public void setFinSemanaInicia(String finSemanaInicia) {
    this.finSemanaInicia = finSemanaInicia;
  }

  public Zona finSemanaTermina(String finSemanaTermina) {
  ...
  @Schema(description = "")
    ...
    public String getFinSemanaTermina() {
    return finSemanaTermina;
  }

  public void setFinSemanaTermina(String finSemanaTermina) {
    this.finSemanaTermina = finSemanaTermina;
  }
