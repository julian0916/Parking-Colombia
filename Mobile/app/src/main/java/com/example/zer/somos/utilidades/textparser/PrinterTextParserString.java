...
import com.example.zer.somos.utilidades.EscPosCharsetEncoding;
...
public class PrinterTextParserString implements IPrinterTextParserElement {
    ...
    public int length() throws EscPosEncodingException {
        com.example.zer.somos.utilidades.EscPosCharsetEncoding charsetEncoding = this.printer.getEncoding();
