...
public class EscPosPrinterCommands {
    ...
    private com.example.zer.somos.utilidades.EscPosCharsetEncoding charsetEncoding;
    ...
    public static byte[] bitmapToBytes(Bitmap bitmap) {
        ...
        byte[] imageBytes = com.example.zer.somos.utilidades.EscPosPrinterCommands.initGSv0Command(bytesByLine, bitmapHeight);
    ...
    public static byte[][] convertGSv0ToEscAsterisk(byte[] bytes) {
        ...
        returnedBytes[0] = com.example.zer.somos.utilidades.EscPosPrinterCommands.LINE_SPACING_24;
        for (int i = 0; i < imageLineHeightCount; ++i) {
            ...
            imageBytes[imageBytes.length - 1] = com.example.zer.somos.utilidades.EscPosPrinterCommands.LF;
            returnedBytes[i + 1] = imageBytes;
        }
        returnedBytes[returnedBytes.length - 1] = com.example.zer.somos.utilidades.EscPosPrinterCommands.LINE_SPACING_30;
    ...
    public static byte[] QRCodeDataToBytes(String data, int size) throws EscPosBarcodeException {
        ...
        if (byteMatrix == null) {
            return com.example.zer.somos.utilidades.EscPosPrinterCommands.initGSv0Command(0, 0);
        }
        ...
        byte[] imageBytes = com.example.zer.somos.utilidades.EscPosPrinterCommands.initGSv0Command(bytesByLine, imageHeight);
     ...
     */
    public EscPosPrinterCommands(DeviceConnection printerConnection, com.example.zer.somos.utilidades.EscPosCharsetEncoding charsetEncoding) {
        this.printerConnection = printerConnection;
        this.charsetEncoding = charsetEncoding != null ? charsetEncoding : new com.example.zer.somos.utilidades.EscPosCharsetEncoding("windows-1252", 6);
    }

    /**
     * Start socket connection and open stream with the device.
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands connect() throws EscPosConnectionException {
     ...
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands reset() {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
        this.printerConnection.write(com.example.zer.somos.utilidades.EscPosPrinterCommands.RESET_PRINTER);
        return this;
    }
     ...
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands setAlign(byte[] align) {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize, byte[] textColor) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline) throws EscPosEncodingException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printText(String text, byte[] textSize, byte[] textColor, byte[] textReverseColor, byte[] textBold, byte[] textUnderline, byte[] textDoubleStrike) throws EscPosEncodingException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }

        if (textSize == null) {
            textSize = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_SIZE_NORMAL;
        }
        if (textColor == null) {
            textColor = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_COLOR_BLACK;
        }
        if (textReverseColor == null) {
            textReverseColor = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_COLOR_REVERSE_OFF;
        }
        if (textBold == null) {
            textBold = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_WEIGHT_NORMAL;
        }
        if (textUnderline == null) {
            textUnderline = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_UNDERLINE_OFF;
        }
        if (textDoubleStrike == null) {
            textDoubleStrike = com.example.zer.somos.utilidades.EscPosPrinterCommands.TEXT_DOUBLE_STRIKE_OFF;
        }
    ...
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printAllCharsetsEncodingCharacters() throws EscPosConnectionException {
    ...
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printCharsetsEncodingCharacters(int[] charsetsId) throws EscPosConnectionException {
    ...
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printCharsetEncodingCharacters(int charsetId) throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands useEscAsteriskCommand(boolean enable) {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printImage(byte[] image) throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }

        byte[][] bytesToPrint = this.useEscAsteriskCommand ? com.example.zer.somos.utilidades.EscPosPrinterCommands.convertGSv0ToEscAsterisk(image) : new byte[][] {image};
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands printQRCode(int qrCodeType, String text, int size) throws EscPosEncodingException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands newLine() throws EscPosConnectionException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands newLine(byte[] align) throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }

        this.printerConnection.write(new byte[]{com.example.zer.somos.utilidades.EscPosPrinterCommands.LF});
        this.printerConnection.send();
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands feedPaper(int dots) throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands cutPaper() throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinterCommands openCashBox() throws EscPosConnectionException {
        if (!this.printerConnection.isConnected()) {
            return this;
        }
     ...
     */
    public com.example.zer.somos.utilidades.EscPosCharsetEncoding getCharsetEncoding() {
