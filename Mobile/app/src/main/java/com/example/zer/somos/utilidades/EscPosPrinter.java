...
import com.example.zer.somos.utilidades.textparser.IPrinterTextParserElement;
import com.example.zer.somos.utilidades.textparser.PrinterTextParser;
import com.example.zer.somos.utilidades.textparser.PrinterTextParserColumn;
import com.example.zer.somos.utilidades.textparser.PrinterTextParserLine;
import com.example.zer.somos.utilidades.textparser.PrinterTextParserString;
...
public class EscPosPrinter extends EscPosPrinterSize {
     ...
     */
    public EscPosPrinter(DeviceConnection printerConnection, int printerDpi, float printerWidthMM, int printerNbrCharactersPerLine, com.example.zer.somos.utilidades.EscPosCharsetEncoding charsetEncoding) throws EscPosConnectionException {
     ...
     */
    public com.example.zer.somos.utilidades.EscPosPrinter disconnectPrinter() {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter useEscAsteriskCommand(boolean enable) {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedText(String text) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedText(String text, float mmFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedText(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedTextAndCut(String text) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedTextAndCut(String text, float mmFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedTextAndCut(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        if (this.printer == null || this.printerNbrCharactersPerLine == 0) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedTextAndOpenCashBox(String text, float mmFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printFormattedTextAndOpenCashBox(String text, int dotsFeedPaper) throws EscPosConnectionException, EscPosParserException, EscPosEncodingException, EscPosBarcodeException {
        if (this.printer == null || this.printerNbrCharactersPerLine == 0) {
            return this;
        }
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printAllCharsetsEncodingCharacters() throws EscPosConnectionException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printCharsetsEncodingCharacters(int[] charsetsId) throws EscPosConnectionException {
     ...
     * @return Fluent interface
     */
    public com.example.zer.somos.utilidades.EscPosPrinter printCharsetEncodingCharacters(int charsetId) throws EscPosConnectionException {
