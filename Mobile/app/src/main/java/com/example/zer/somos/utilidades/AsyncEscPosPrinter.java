...
public class AsyncEscPosPrinter extends EscPosPrinterSize {
    ...
    public com.example.zer.somos.utilidades.AsyncEscPosPrinter setTextsToPrint(String[] textsToPrint) {
        this.textsToPrint = textsToPrint;
        return this;
    }

    public com.example.zer.somos.utilidades.AsyncEscPosPrinter addTextToPrint(String textToPrint) {
